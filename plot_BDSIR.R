#library(NELSI)
setwd("C:/Siavash/Codes/Phylogenetic_softwares/BEAST_2.6.7")

data <- read.table('alignment_prs.log', head = T)
...
par(mfrow = c(2, 2))
plot(t, I, type = 'l', ylim = c(1, max(S)), col = 'orange', ylab = 'Number of individuals', main = 'SIR trajectories', xlab = 'Time',log='y')
lines(t, R, col = 'blue')
lines(t, S, col = 'green')
...
plot(t, I, type = 'l', main = 'Prevalence and incidence', ylab = 'Number of individuals', col = 'orange', xlab = 'Time',log='y')
